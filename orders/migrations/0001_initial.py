# Generated by Django 5.1.1 on 2024-11-26 05:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('waiting_confirmation', 'Ожидание подтверждения'), ('completed', 'Оплачено'), ('canceled', 'Отменено')], default='waiting_confirmation', max_length=20)),
