# Generated by Django 5.1.1 on 2024-12-02 03:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Создано'), ('waiting_confirmation', 'Ожидание подтверждения'), ('completed', 'Оплачено'), ('set', 'Отправленно'), ('get', 'Отправленно'), ('canceled', 'Отменено')], default='created', max_length=20)),
