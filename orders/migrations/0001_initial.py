    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Создано'), ('waiting_confirmation', 'Ожидание подтверждения'), ('completed', 'Оплачено'), ('canceled', 'Отменено'), ('shipped', 'Отправлено'), ('delivered_signed', 'Доставлено под роспись')], default='created', max_length=20)),
